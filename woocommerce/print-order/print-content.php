...
?>
	...
	<div class="order-branding">
		...
		<div class="company-info">
			...
			if ( ! wcdn_get_company_logo_id() ) :
				...
				<h3 class="date">Datum vydání faktury: <?php echo date("d.m. Y"); ?></h3>
				<h1 class="order-side-type">Dodavatel</h1>
	...
	if ( ! wcdn_has_shipping_address( $order ) ) :
		...
		<h1 class="order-side-type">Odběratel</h1>
	...
	<div class="order-items">
		<table>
					...
					<?php foreach ( $order->get_items() as $item ) : ?>
						...
						<tr>
							...
							<td class="product-price">
								<span>
									<?php echo wp_kses_post( $order->get_formatted_line_subtotal( $item) ); ?><br/>
									 (<?php echo str_replace("(", "", str_replace(")", "", wp_kses_post( $order->get_formatted_line_subtotal( $item, 'excl' ) ))); ?>)
								</span>
							</td>
						</tr>
					<?php endforeach; ?>
			...
			<tfoot>
				...
				$curesymb =  get_woocommerce_currency_symbol();
				if ( $totals_arr ) :
							...
							<td class="total-price">
								<span>
									...
									<?php if ($key === "cart_subtotal"): ?>
										 <br />
										(<?php echo $order->get_subtotal(); ?> <?php echo $curesymb; ?> <small class="woocommerce-Price-taxLabel tax_label">bez DPH</small>)
									<?php endif; ?>
									<?php if ($key==="shipping"): ?>
										<br />
										(<?php echo round(($order->get_shipping_total() / 121) * 100); ?> <?php echo $curesymb; ?> <small class="woocommerce-Price-taxLabel tax_label">bez DPH</small>)
									<?php endif; ?>
								</span>
							</td>
						</tr>
